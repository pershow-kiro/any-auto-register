...
CONFIG_KEYS = [
    ...
    "cloudmail_api_url", "cloudmail_admin_email", "cloudmail_admin_password", "cloudmail_domain",
    "moemail_api_url",
    "mail_provider",
    ...
    "sub2api_url", "sub2api_api_key", "sub2api_concurrency", "sub2api_priority", "sub2api_group_ids",
